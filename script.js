...
function makeList() {
  ...
  numberOfListItems = countryArray.length,
  listItem,
  i;

  document.getElementById("mySidebar").appendChild(listContainer);
  listContainer.appendChild(listElement);

  for (let i = 0; i < numberOfListItems; i++) {
    listItem = document.createElement('li');
    listItem.innerHTML = countryArray[i];
    listElement.appendChild(listItem);
    // console.log(listItem[i]);
    listElement.classList.add("sidebarCountries");
